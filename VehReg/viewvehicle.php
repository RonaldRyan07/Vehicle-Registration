        ...
        <?php while($r = $results->fetch(PDO::FETCH_ASSOC)) { ?>
           <tr>
                ...
                <td style="text-align: left;padding: 8px;">
                    <a onclick="return confirm('Are you sure you want to EDIT this vehicle?');" href="editvehicle.php?id=<?php echo $r['veh_id'] ?>"><button class="abutton">EDIT</button></a>
                    <a onclick="return confirm('Are you sure you want to DELETE this vehicle?');" href="deletevehicle.php?id=<?php echo $r['veh_id'] ?>"><button class="abutton">DELETE</button></a>
                </td>
           </tr> 
        <?php }?>
    </table>
